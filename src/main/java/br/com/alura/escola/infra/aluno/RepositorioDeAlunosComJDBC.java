    ...
    public List<Aluno> listarTodosAlunosMatriculados() {
        try {
            ...
            while (rs.next()) {
                ...
                ResultSet rsTeResultSet = psTelefone.executeQuery();
                while (rsTeResultSet.next()) {
                    String numero = rsTeResultSet.getString("numero");
                    String ddd = rsTeResultSet.getString("ddd");
